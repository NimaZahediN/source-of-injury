...
async def main():
    injury_sources = [
        ...
        "Insects, arachnids (spiders, ticks, scorpions, mosquitos)",
        "Rails",
        "Recreation and athletic equipment, uns. OR n.e.c.",
        "Packages, parcels",
        "Tires, except bike OR Tires, inner tubes, wheels, uns. OR n.e.c.",
        "Rocks, crushed stone",
        "Wheels, tire rims",
        "Glass chips or fibers",
        "Ladders, uns. OR n.e.c.",
        "Drills",
        "Customer",
        "Garment racks, other racks",
        "Electrical wiring",
        "Chemicals and chemical products, uns. OR n.e.c.",
        "Brooms, mops, and other cleaning tools",
        "Beverages, uns. OR n.e.c.",
        "Ice, sleet, snow",
        "Counters, counter tops",
        "Containers -- nonpressurized, uns. OR n.e.c.",
        "Other food products -- fresh or processed, uns. OR n.e.c.",
        ...
        "Wire -- nonelectrical",
        "Food and beverage processing machinery -- specialized, uns. OR n.e.c.",
        "Scrap, waste, debris, uns. OR n.e.c.",
        "Cold -- environmental",
        "Floor of vehicle",
        ...
        "Cattle",
        "Fire, flame",
        "Cleaning and polishing agents, uns. OR n.e.c. OR Other cleaning and polishing agents, uns. OR n.e.c.",
        "Sawdust",
        "Scissors, snips, shears",
        "Roof",
        "Containers -- pressurized, uns. OR n.e.c.",
        "Nuts, bolts, washers",
        "Tear gas, mace",
        "Train",
        "Staples",
        "Venom",
        "Forklift, uns. OR n.e.c.",
        "Electric parts, uns. OR n.e.c.",
        "Sofas",
